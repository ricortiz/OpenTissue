  ...
  namespace bvh
  {
    ...
    */
    ...
    public:
      ...
      node_iterator       sub_node_begin()       { return m_sub_nodes.begin(); }
      node_iterator       sub_node_end()         { return m_sub_nodes.end();   }
      const_node_iterator sub_node_begin() const { return m_sub_nodes.begin(); }
      const_node_iterator sub_node_end()   const { return m_sub_nodes.end();   }

      node_ptr_container       sub_nodes()       { return m_sub_nodes; }
      const node_ptr_container sub_nodes() const { return m_sub_nodes; }
    ...
    public:
      ...
      */
      ...
      const unsigned int max_sub_node_height() const
      {
        ...
        for(auto &node : m_sub_nodes)
        {
          max_height = std::max(max_height, node->m_height);
        }
        return max_height;
      }
      ...
      const unsigned int min_sub_node_height()const
      {
        ...
        for(auto &node : m_sub_nodes)
        {
          min_height = std::min(min_height, node->m_height);
        }
        return min_height;
      }
