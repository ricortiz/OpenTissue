		...
		namespace big
		{
			namespace detail
			{
				...
				inline T hypot(T const &a, T const &b)
				{
					...
					T const zero = OpenTissue::utility::numeric_cast<T>( 0.0 );
					T const one  = OpenTissue::utility::numeric_cast<T>( 1.0 );
									  ...
									  )
				{
					...
					value_type const zero = OpenTissue::utility::numeric_cast< value_type >( 0.0 );
					value_type const one  = OpenTissue::utility::numeric_cast< value_type >( 1.0 );
					value_type const two  = OpenTissue::utility::numeric_cast< value_type >( 2.0 );
					value_type const eps  = OpenTissue::utility::numeric_cast<value_type>( pow( 2.0, -52.0 ) );
