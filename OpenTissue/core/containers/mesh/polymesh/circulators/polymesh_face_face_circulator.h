  ...
  namespace polymesh
  {
    ...
    */
    ...
    public:
      ...
      explicit PolyMeshFaceFaceCirculator(std::shared_ptr<typename PolyMesh::face_type> f)
        : m_circ(f)
      {}
    ...
    public:
      ...
      PolyMeshFaceFaceCirculator begin() { return *this; }
      PolyMeshFaceFaceCirculator end()   { return PolyMeshFaceFaceCirculator(); }
