#ifndef CURVATURE_MESH_VOLUME_REFITTER_H
#define CURVATURE_MESH_VOLUME_REFITTER_H
//
...
public:
  ...
  void refit(bv_ptr bv)
  {
    ...
    if(bv->is_leaf())
    {
      ...
      vector3_type n;
      compute_face_normal( *geometry, n);
      // static  std::vector<vector3_type> d26;
      // OpenTissue::geometry::create_lut26(d26);
      //bv->m_dir_lut = OpenTissue::geometry::direction_bitmask( d26.begin(),d26.end(), n);
    }
    else
    {
      bv->m_dir_lut = 0xFFFF;
...
// CURVATURE_MESH_VOLUME_REFITTER_H
#endif
